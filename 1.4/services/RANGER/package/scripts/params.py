...
ranger_conf    = '/etc/ranger/admin/conf'
ranger_stop    = '/usr/lib/ranger-admin/ews/stop-ranger-admin.sh'
ranger_start   = '/usr/lib/ranger-admin/ews/start-ranger-admin.sh'
usersync_home  = '/usr/lib/ranger-usersync'
...
usersync_services_file = "/usr/lib/ranger-usersync/ranger-usersync-services.sh"
...
usersync_log_dir = default("/configurations/ranger-env/ranger_usersync_log_dir", "/var/log/ranger")
admin_log_dir = default("/configurations/ranger-env/ranger_admin_log_dir", "/var/log/ranger")
